(function() {
  ...
  var _sfc_render = function render() {
    ...
    return _c("k-panel-inside", { staticClass: "k-content-watch-view" }, [_c("k-header", { staticClass: "k-section-header" }, [_c("div", { staticClass: "k-content-watch-tabs" }, [_c("k-button-group", [_c("k-button", { class: { "k-button-active": _vm.tab === "content" }, attrs: { "icon": "edit-line" }, on: { "click": function($event) {
      ...
      _vm.tab = "locked";
    } } }, [_vm._v(" Locked Pages ")])], 1)], 1), _c("k-button-group", { attrs: { "slot": "right" }, slot: "right" }, [_c("k-button", { attrs: { "icon": "refresh" }, on: { "click": _vm.refresh } })], 1)], 1), _vm.tab === "content" ? _c("section", { staticClass: "k-content-watch-section" }, [_vm.files.length ? _c("k-grid", { attrs: { "gutter": "small" } }, [_c("k-column", { attrs: { "width": "2/3" } }, [_c("k-input", { staticClass: "k-content-watch-search", attrs: { "type": "text", "placeholder": _vm.$t("search") + "...", "icon": "search" }, on: { "input": _vm.filterFiles }, model: { value: _vm.search, callback: function($$v) {
      _vm.search = $$v;
    }, expression: "search" } })], 1), _c("k-column", { attrs: { "width": "1/3" } }, [_c("k-button-group", [_c("k-button", { class: { "k-button-active": _vm.showOnlyPages }, attrs: { "icon": "page" }, on: { "click": _vm.toggleShowOnlyPages } }, [_vm._v("Pages only")]), _c("k-button", { class: { "k-button-active": !_vm.showOnlyPages }, attrs: { "icon": "file-document" }, on: { "click": _vm.toggleShowAll } }, [_vm._v("All files")])], 1)], 1)], 1) : _vm._e(), _vm.files.length && _vm.paginatedFiles.length ? _c("div", { staticClass: "k-content-watch-files" }, _vm._l(_vm.paginatedFiles, function(file, index) {
